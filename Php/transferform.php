                    ...
                    <div class="container">
                        <fieldset><br>
                            <label style="margin-left: 19px;">From Account <span>*</span></label>
                                <input type="text" required placeholder="Your Account Number" name="facc">
                            <label style="margin-left: 30px;">To Account  <span>*</span></label>
                                <input type="text" required placeholder="Receiver's Account Number" name="tacc"><br><br>
                            <label style="margin-left: 60px;">Amount <span>*</span></label>
                                <input type="text" required placeholder="Amount " name="amt">
                            ...
                            <label id="reason" style="margin-left: 30px;">Remark</label>
                                <textarea placeholder="Type your message" rows="3" cols="3" name="remark"></textarea><br><br><br><br>

...
<body>
	...
	<div class="form-container">
		...
		<form name="loanform" action="/Php/loanform1.php"Method="Post"onsubmit="">
            ...
            <input type="number" id="loan-amount" name="loanamount" min="1" required>

            <label for="loan-type">Loan-Type:</label>
			<input type="text" name="loantype" id="loantype" required><br><br>

            <label for="employementstatus">Employement-Status:</label>
			<input type="text" name="employementstatus" id="employementstatus" required><br><br>



                <button type="submit" onclick="validateForm();">Apply Now</button>
		</form>
	</div>
    <div class="copyright">

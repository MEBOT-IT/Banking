            ...
            <div class="item">
                    ...
                    <fieldset style="padding-bottom: 30px;">
                            ...
                            <div class="cust">
                                ...
                                <input id="phone" type="tel" name="phno" required> <br><br>
                            ...
                            <div class="cust">
                                ...
                                <label style="margin-left: -35px;">
                                    ...
                                    <input id="biller-name" type="text" name="billername" required> 

                                <label style="margin-left: 245px;">Amount <span style="color: red;"> *</span></label>
                                    <input id="amount" type="text" name="amount" required> <br><br><br><br>

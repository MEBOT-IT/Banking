...
<body>
        ...
        <div class="formcontainer">
            ...
            <form id="cform" action="/Php/netcreditbill1.php" method="post">
                <div class="formcon">
                    ...
                    <input type="text" id="cnum" name="cnum" placeholder="Enter 12-digit credit card number" required>
                </div>

                <div class="formcon">
                    <label for="rcnum">Re-enter Credit Card number : </label>
                    <input type="text" id="rcnum" name="rcnum" placeholder="Re-enter credit card number" required>
                </div>

                <div class="formcon">
                    <label for="amt">Bill Amount : </label>
                    <input type="text" id="amt" name="amt" placeholder="Enter bill amount to pay" required>
                </div>
    ...
    <script src="/JS/netbill.js"></script>
</body>
</html>